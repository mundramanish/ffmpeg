...
//  StructureApp
// 
//  Created By: App Infotech Ltd
//  Created on: 11/11/17 11:00 AM - (App)
//  
//  Copyright © 2017 App Infotech Ltd. All rights reserved.
//  
//  
...
//        let strMessage = message!
    ...
    ///   - completion: You will get the call back here when user tap on the button from the alert.
    ///
    ///     - Index For "Use Gallery" button = 1
    ///     - Index For "Use Camera" button = 0
    ///     - Index For "Cancel" button = 2
    class func showActionsheetForImagePicker(controller: AnyObject ,
                                             message: String? = nil ,
                                             completion: ((Int, String) -> Void)?) {
        
        showAlert(controller: controller, message: message, style: .actionSheet, cancelButton: "Cancel", distrutiveButton: nil, otherButtons: ["Camera", "Gallery"], completion: completion)
        
    }

    class func showActionsheetForDelete(controller: AnyObject ,
                                             message: String? = nil ,
                                             completion: ((Int, String) -> Void)?) {

        showAlert(controller: controller, message: message, style: .actionSheet, cancelButton: "Cancel", distrutiveButton: "Delete", otherButtons: nil, completion: completion)
